...
#region 脚本工具生成的代码
        ...
        {
            Show();
            L2C_GetPlayerMiltary l2CGetPlayerMiltary = (L2C_GetPlayerMiltary)await SessionComponent.Instance.Call(new C2L_GetPlayerMiltary()
            {
        ...
        {
            L2C_GetMiltaryRecordDataInfo l2CGetMiltaryRecordData = (L2C_GetMiltaryRecordDataInfo)await SessionComponent.Instance.Call(new C2L_GetMiltaryRecordDataInfo()
            {
                DataId = recordId
            });
            if (string.IsNullOrEmpty(l2CGetMiltaryRecordData.Message))
            {
                ...
                CardFiveStarVideoEntry.EnterRoom(l2CGetMiltaryRecordData.RecordDataInfo);
