...
#region 脚本工具生成的代码
        ...
        public void InitPlayerInfo()
        {
            ...
            {
                FrienCircleRoomPlayerInfoItem frienCircleRoomPlayerInfoItem = playerItemParent.GetChild(i).AddItemIfHaveInit<FrienCircleRoomPlayerInfoItem, MatchPlayerInfo>(mData.MatchPlayerInfos[i]);
        ...
        public void JoinRoom()
        {
            ...
            CardFiveStarEntry.JoinRoom(mData.RoomId);
        }
