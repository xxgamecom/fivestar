...
namespace ETModel
{
    ...
    public enum AppType
    {
        ...
        // 
        ClientH = 1 << 30, // 客户端Hotfix层
        ClientM = 1 << 31, // 客户端Model层

        // 8
        AllServer = Manager | Realm | Gate | Http | DB | Location | Lobby | User | Match | FriendsCircle | JoyLandlords | CardFiveStar | BenchmarkWebsocketServer
    }
