...
namespace ETHotfix
{
    public static class FriendsCircleSystem
    {
        ...
        {
            var memberInfo = await FriendsCircleComponent.Ins.QueryFriendsCircleMember(friendsCircle.FriendsCircleId);
            ...
            var applyFriendsCirleInfo = await FriendsCircleComponent.Ins.QueryFriendsCircleApply(friendsCircle.FriendsCircleId);
        ...
        {
            var userInFriendsCircle = await FriendsCircleComponent.Ins.QueryUserInFriendsCircle(userId);
            ...
            var friendsCirleMemberInfo = await FriendsCircleComponent.Ins.QueryFriendsCircleMember(friendsCircle.FriendsCircleId);
        ...
        public static async Task KickOutFriendsCircle(this FriendsCircle friendsCircle, long operateUserId, long byOperateUserId, IResponse iResponse)
        {
            ...
            var applyFriendsCirleInfo = await FriendsCircleComponent.Ins.QueryFriendsCircleMember(friendsCircle.FriendsCircleId);
        ...
        public static async void RankingGameReult(this FriendsCircle friendsCircle, RepeatedField<TotalPlayerInfo> totalPlayerInfos)
        {
            ...
            {
                var ranKingPlayerInfo = await friendsCircle.QueryRankingInfo(totalPlayerInfos[i].UserId);
        ...
        {
            var ranKingPlayerInfos = await FriendsCircleComponent.Ins.dbProxyComponent.Query<RanKingPlayerInfo>(ranking => ranking.UserId == userId && ranking.FriendsCircleId == friendsCircle.FriendsCircleId);
