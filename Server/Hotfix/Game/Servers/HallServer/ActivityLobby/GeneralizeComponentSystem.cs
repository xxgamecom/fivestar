...
namespace ETHotfix
{
    public static class GeneralizeComponentSystem
    {
        public static async Task GetGreenGift(this GeneralizeComponent generalizeComponent, long getUserId, long initeUserId, IResponse iResponse)
        {
            ...
            User user = await UserHelper.QueryUserInfo(initeUserId);
            if (user == null)
            {
            ...
            UserHelper.GoodsChange(getUserId, GoodsId.Jewel, GeneralizeComponent.AwardJewelNum, GoodsChangeType.GeneralizeAward, true);
            UserHelper.GoodsChange(initeUserId, GoodsId.Jewel, GeneralizeComponent.AwardJewelNum, GoodsChangeType.GeneralizeAward);
        }
